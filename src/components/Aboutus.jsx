...
export default function Aboutus() {
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto px-4 flex flex-col md:flex-row my-10 mb-20">
        <div className="order-2 md:order-1 w-full md:w-1/2 mt-10 md:mt-0 flex justify-center">
          <img
            src={pic1}
        ...
        <div className="order-1 md:order-2 w-full md:w-1/2 mt-10 md:mt-20 px-4">
          <div className="space-y-8">
            ...
            <p className="text-sm md:text-base">
              ...
              and guidance they need to excel. Our online classes make it convenient for students from all over the world to access top-notch Quranic
              education from the comfort of their homes. We are committed to nurturing a love for the Quran and its teachings in all our students,
