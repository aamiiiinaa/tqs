...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a onClick={() => scrollToSection("testimonial")}>Testimonial</a>
      </li>
      <li>
  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        sticky ? "shadow-md bg-base-200 dark:bg-slate-700 transition-all duration-300" : ""
      }`}
    >
      <div className="navbar">
        <div className="navbar-start">
          ...
          <a className="text-2xl font-bold cursor-pointer flex items-center">
            <img src={logo} alt="Logo" className="w-12 h-12 mr-2" />
            <span className="whitespace-nowrap">The Quran Class</span>
          </a>
        </div>
